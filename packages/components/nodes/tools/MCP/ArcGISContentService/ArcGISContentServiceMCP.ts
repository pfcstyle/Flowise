...
class ArcGISLocationService_MCP implements INode {
    ...
    constructor() {
        this.label = 'ArcGIS Content Service MCP'
        this.name = 'arcgisContentServiceMCP'
        this.version = 1.0
        this.type = 'ArcGIS Content Service MCP Tool'
        this.icon = 'arcGISContentServiceMCP.svg'
        this.category = 'Tools (MCP)'
        this.description = 'MCP Server for ArcGIS Content Management Services'
